...
function FilterableSpell(props) {
	return (
		<li className='p-1e'>
			<h3 className='m-t-0'>{props.spell.name}</h3>
			<p className='m-05e italic color-aaa'>{`${props.spell.school}; ${props.spell.spell_level}`}</p>
			<ul>
			...
			<p className='m-b-0'>{props.spell.description}</p>
		</li>
	);
}
